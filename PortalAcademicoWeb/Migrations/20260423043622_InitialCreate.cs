...
namespace PortalAcademicoWeb.Migrations
{
    /// <inheritdoc />
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Curso_Horario", "\"HorarioFin\" > \"HorarioInicio\"");
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "CS101", 4, 30, new TimeOnly(10, 0, 0), new TimeOnly(8, 0, 0), "Introducción a Programación" },
                    { 2, true, "MAT201", 3, 25, new TimeOnly(12, 0, 0), new TimeOnly(10, 0, 0), "Cálculo Diferencial" },
                    { 3, true, "FIS101", 5, 20, new TimeOnly(17, 0, 0), new TimeOnly(14, 0, 0), "Física Mecánica" }
                });
